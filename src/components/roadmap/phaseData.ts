...
export const PHASES: Phase[] = [
  ...
  },
  {
    ...
    successCriteria: [
      "An external program can, through /api/v1, inspect configuration concerns and show state, create a fixture pool, mint/list/revoke scoped API keys, apply an ordered multi-command batch atomically, and subscribe to revisioned change events — each dispatched through the same internal command route registry the desktop UI uses.",
  ...
  {
    n: 9,
    title: "Front-Door UI Completion",
    body: "A new operator can go from a fresh checkout to a patched fixture and a scene on screen using only the UI, with Guided First Show onboarding as the on-ramp.",
    status: "done",
    icon: "faders",
    ...
    successCriteria: [
      "A user can browse, inspect, and import fixture definitions (OFL and hand-authored YAML) through the Fixture Library workspace.",
      "A user can open an existing show, create a new show, and switch between shows through on-screen controls.",
      "A first-time user can complete Guided First Show onboarding to go from an empty app to a patched fixture and a scene on screen.",
    ],
    plans: "7/7 plans complete",
  },
  {
    ...
    dependsOn: "Phases 2, 6, 7, 8, and 9",
  ...
  {
    n: 13,
    title: "Unified UI Design System and Automated Enforcement",
    body: "Every reachable desktop surface uses one documented Paper/Ink design system whose tokens, components, accessibility states, and theme parity are mechanically enforced with zero unregistered drift.",
    status: "active",
    icon: "gear",
