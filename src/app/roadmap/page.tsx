...
const roadmapDescription = "GOLC v1 ships through thirteen dependency-ordered phases.";
  ...
  return (
    <div className="mx-auto max-w-290 px-6 py-16 sm:px-12 sm:py-24">
      <span className="block font-mono text-[13px] tracking-[1.3px] text-link">
        Thirteen dependency-ordered phases
      </span>
      ...
      <p className="mt-4 max-w-xl text-text2">
        GOLC v1 grows through thirteen dependency-ordered MVP slices. Each
